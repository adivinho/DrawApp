...
public class RectangleShape extends Shapes{
  //   
	...
	public void createControlAnchorsFor(Group root) {
		...
		getShapeAnchors()[0] = upleft = new Anchor(getPoints()[0], getPoints()[1], this, root);
		getShapeAnchors()[1] = upright = new Anchor(getPoints()[2], getPoints()[3], this, root);

		getShapeAnchors()[2] = downleft = new Anchor(getPoints()[4], getPoints()[5], this, root);
		getShapeAnchors()[3] = downright = new Anchor(getPoints()[6], getPoints()[7], this, root);
